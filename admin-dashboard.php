    ...
    <div class="container-fluid py-4">
      ...
      <div id="dashboard-section">
        <div class="row g-3 mb-4">
          <div class="col-md-3">
            <div class="summary-card">
              <h3 id="total-users">1200</h3>
              <p>Total Users</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="summary-card">
              <h3 id="total-employers">350</h3>
              <p>Total Employers</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="summary-card">
              <h3 id="active-jobs">78</h3>
              <p>Active Jobs</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="summary-card">
              <h3 id="total-applications">2150</h3>
              <p>Applications</p>
            </div>
          </div>
        </div>
        ...
        <div class="row g-4 mb-4">
          ...
          <div class="col-md-6">
            <div class="p-3 bg-light rounded shadow-sm">
              <h5>Applications by Category</h5>
        ...
        <div class="row g-4 mb-4">
          <div class="col-md-6">
            <div class="p-3 bg-white rounded shadow-sm">
              ...
              <ul class="list-group">
                <li class="list-group-item">John Doe - 2025-09-10</li>
                <li class="list-group-item">Jane Smith - 2025-09-09</li>
                <li class="list-group-item">Alice Johnson - 2025-09-08</li>
              </ul>
            </div>
          </div>
          <div class="col-md-6">
            <div class="p-3 bg-white rounded shadow-sm">
              <h5>Pending Employer Approvals</h5>
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  TechCorp Inc <span class="badge bg-warning text-dark">Pending</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  DesignStudio <span class="badge bg-warning text-dark">Pending</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <table class="table table-hover table-dark">
            ...
            <tbody>
              <tr>
                ...
                <td>Having trouble uploading my resume.</td>
                <td>2025-09-11</td>
              </tr>
              <tr>
                <td>F002</td>
                ...
                <td>Can you add more job categories?</td>
                <td>2025-09-10</td>
              </tr>
              <tr>
                <td>F003</td>
                ...
                <td>My application status isn't updating.</td>
                <td>2025-09-09</td>
              </tr>
            </tbody>
          </table>
